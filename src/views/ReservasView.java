...
public class ReservasView extends JFrame {
	...
	private void guardarReserva() {
		...
		Reserva reserva = new Reserva(java.sql.Date.valueOf(fechaE), java.sql.Date.valueOf(fechaS), txtValor.getText(),
				txtFormaPago.getSelectedItem().toString());

		reservaController.guardar(reserva);

		JOptionPane.showMessageDialog(contentPane, "Reserva hecha con exito. Id nro: " + reserva.getId());
	}
